    ...
    if message == OnEnter then
		if Object.Get_Planet_Location() == FindPlanet("Kamino") and GlobalValue.Get("CURRENT_ERA") > 1 then
			land_IV_list = {
				...
				{"Commander_Tier_IV_Republic_AT_RT_Walker_P1_Company", "Republic_BARC_Company", false},
				{"Commander_Tier_IV_Republic_AT_RT_Walker_P2_Company", "Republic_BARC_Company"},
				}
			land_III_list = {
				{"Commander_Tier_III_Clone_Scout_Trooper_Company", "Clonetrooper_Phase_Two_Company"}, 
				{"Commander_Tier_III_Clone_Airborne_Trooper_Company", "Clonetrooper_Phase_Two_Company"},
				}
			land_II_list  = {
				{"Commander_Tier_II_Clone_Special_Ops_Company", "Clonetrooper_Phase_Two_Company", false},
				{"Commander_Tier_II_Clone_Galactic_Marine_Company", "Clonetrooper_Phase_Two_Company"},
				}
			land_I_list  = {
