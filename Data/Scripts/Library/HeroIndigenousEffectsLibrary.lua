return {
	...
	--Republic
		...
		-- FotR_Enhanced ; Faction text
		TARKIN2 = {
			HeroName = "TARKIN_EXECUTRIX",
			GroundPerception = "Tarkin_In_Orbit",
			RecruitingFaction = "ENEMY",
			RecruitingMessage = "Wilhuff Tarkin's callous disregard towards the populace has emboldened the local partisans into fighting against the Empire",
		},
		SLAYKE1 = {
