return {
	Ship_Crew_Requirement = 44,
	Fighters = {},
	EmblemData = {
		OCF = {
			mesh_to_hide = {"ARQUITENS"},
			mesh_to_reveal = {"ARQUITENS_OCA"},
