...
function TechHandler:new(galactic_conquest, human_player, planets, unlocktech)
	...
	self.CloneSwap = GenericSwap("CLONE_UPGRADES", "EMPIRE", -- FotR_Enhanced 
		{"Cody", "Rex", "Appo", "Commander_71", "Bacara", "Jet", "Gree_Clone", "Deviss", "Bly", "Wolffe", "Neyo", "Alpha_17", "Fordo", "Ordo_Skirata", "Aden_Skirata", "Kligson", "Rom_Mohc", "Prudii_Skirata"},
		{"Cody2_Team", "Rex2_Team", "Appo2_Team", "Commander_71_2_Team", "Bacara2_Team", "Jet2_Team", "Gree2_Team", "Deviss2_Team", "Bly2_Team", "Wolffe2_Team", "Neyo2_Team", "Alpha_17_2_Team", "Fordo2_Team", "Ordo_Skirata2_Team", "Aden_Skirata2_Team", "Kligson2_Team", "Rom_Mohc2_Team", "Prudii_Skirata2_Team"})
