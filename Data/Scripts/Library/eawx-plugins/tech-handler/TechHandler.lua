...
function TechHandler:new(galactic_conquest, human_player, planets, unlocktech)
	...
	if self.unlocktech ~= false then
		...
		self.ARCActivation = GenericResearch(self.galactic_conquest, -- FotR_Enhanced ; repurpose this for arc training program
			"ARC_ACTIVATION",
	...
	self.CloneSwap = GenericSwap("CLONE_UPGRADES", "EMPIRE", -- FotR_Enhanced 
		...
		"Alpha_17", "Fordo", "Ordo_Skirata", "Aden_Skirata", "Kligson", "Rom_Mohc", "Prudii_Skirata"},
