...
function EventManager:new(galactic_conquest, human_player, planets)
	...
	self.RendiliConquer = GenericConquer(self.galactic_conquest,
        "CONQUER_RENDILI",
        "RENDILI", {"Rebel"},
        {"Mellor_Yago_Rendili_Reign", "Rendili_DHC", "Rendili_DHC", "Rendili_DHC", "Rendili_DHC"}, 
		false)
	
	-- FotR_Enhanced ; Rendili Capture/Recapture for Republic
	self.RendiliConquerREP = GenericConquer(self.galactic_conquest,
        "CONQUER_RENDILI_REP",
        "RENDILI", {"Empire"}, {"Rendili_DHC", "Rendili_DHC", "Rendili_DHC", "Rendili_DHC"}, false, nil, nil, nil, {"DALLIN_UNLLOCK"})
