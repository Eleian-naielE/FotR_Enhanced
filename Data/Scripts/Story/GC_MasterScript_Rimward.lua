...
function Definitions()
    ...
    StoryModeEvents = {
		...
		CIS_Clone_Chaos_Tactical_Completed = State_CIS_Kamino_Conquest,
...
function State_CIS_Rimward_Planet_Checker()
	...
	if FindPlanet("Bothawui").Get_Owner() == p_cis and FindPlanet("Mon_Calamari").Get_Owner() == p_cis and FindPlanet("Rothana").Get_Owner() == p_cis and FindPlanet("Handooine").Get_Owner() == p_cis and FindPlanet("Rodia").Get_Owner() == p_cis then
